  ...
  return (
    <button
      className={classNames(
        'inline-flex items-center gap-1.5 px-3 py-1.5 rounded-sm text-xs transition-colors',
        type === 'primary'
  ...
  return (
    <RadixDialog.Portal>
      ...
      <RadixDialog.Content asChild>
        <motion.div
          className={classNames(
            'fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-gray-950 rounded-sm shadow-xl border border-bolt-elements-borderColor z-[9999] w-[420px] focus:outline-none',
            className,
          )}
          initial="closed"
          animate="open"
